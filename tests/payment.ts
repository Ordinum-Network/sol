...
describe("payment", () => {
    ...
    it("prefund signer (crc)", async() => {
        console.log(await connection.getBalance(CRCPubkey), "CRC Balance before transfervvvvvv")

        await program.methods.prefundSignerAsCrcForPayment(
            trialId,
            sponsor
        ).accounts({
            signer: CRCPubkey,
        ...
        console.log(await connection.getBalance(CRCPubkey), "CRC Balance after transfervvvvv")
    })
    
    it("prefund signer (crc)", async() => {
        console.log(await connection.getBalance(CRCPubkey), "CRC Balance before transferffff")

        await program.methods.prefundSignerAsCrcForAta(
            trialId,
            sponsor
        ).accounts({
            signer: CRCPubkey,
        ...
        console.log(await connection.getBalance(CRCPubkey), "CRC Balance after transferffffff")
    })

    it ("create payment transaction", async() => {
